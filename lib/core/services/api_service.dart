...
class ApiService {
  ...
  Future<HighlightResponse> getHighlight(String id) async {
    try {
      // Return mock data for game highlights
      if (id == '1361') {
  ...
  Future<HighlightResponse> getHighlightsByCategory(String category) async {
    try {
